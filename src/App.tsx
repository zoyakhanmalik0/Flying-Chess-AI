...
function App() {
  ...
  if (currentPage === "privacy") {
    return (
      <PrivacyPolicy setCurrentPage={setCurrentPage} currentPage={currentPage} />
    );
  }
        ...
        <div className="text-center mb-16">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                AI Customer Service Testing ensures that chatbots and virtual
                assistants can handle customer queries accurately, quickly, and
                in a human-like manner. It involves evaluating natural language
                understanding, response quality, personalization, and
                problem-solving efficiency. The goal is to test how well AI
                systems improve customer experience, reduce response time, and
                provide consistent support across multiple platforms.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Advanced machine learning algorithms for optimal performance
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              24/7 intelligent customer service and automated assistance
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Enterprise-grade security with data protection guarantee
            </p>
          </div>
        </div>
      </main>
